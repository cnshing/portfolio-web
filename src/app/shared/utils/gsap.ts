 ...
 * @returns {number}
 */
const safetyScrollThreshold = (self: ScrollTrigger) =>
  Math.abs(self.getVelocity() / 4) + Math.max(25, window.innerHeight * 0.1); // NOTE: Add a minimium of 25 pixels on the off chance velocity is zero
