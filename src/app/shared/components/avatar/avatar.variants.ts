...
export const avatarVariants = cva('relative flex flex-row items-center justify-center box-content cursor-default', {
  variants: {
    zType: {
      default: 'bg-color-button text-on-bg-button hover:bg-color-button/90',
      ...
      secondary: 'bg-color-surface1 border border-color-default text-color-default hover:bg-color-surface1/50',
